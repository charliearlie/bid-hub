...
export default function LoginRegisterRoute() {
  ...
  return (
    <main className="-mt-8 flex h-[calc(100vh-84px)] flex-col flex-wrap content-center gap-4 bg-accent pt-16 dark:bg-background sm:mt-0 sm:justify-center sm:pt-0">
