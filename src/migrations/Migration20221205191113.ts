...
export class Migration20221205191113 extends Migration {

  async up(): Promise<void> {
    this.addSql('drop table if exists "item_categories" cascade;');

    this.addSql('alter table "item" alter column "slug" type varchar(255) using ("slug"::varchar(255));');
  }
  ...
  async down(): Promise<void> {
    ...
    this.addSql('alter table "item" alter column "slug" type jsonb using ("slug"::jsonb);');
  }
